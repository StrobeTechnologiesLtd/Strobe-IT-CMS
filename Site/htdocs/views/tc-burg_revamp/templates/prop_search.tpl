		...
		<div class="property-col1">
			...
			{if file_exists($pic1)}
				...
				{if $prop.PROP_STATUS == "Sold"}
					<div class="propstatus"><img src="{$__imgDir}sold.png" alt="Sold Banner" width="400px" height="267" /></div>
				{/if}
				{if $prop.PROP_STATUS == "Sale Agreed"}
					<div class="propstatus"><img src="{$__imgDir}saleagreed.png" alt="Sale Agreed Banner" width="400px" height="267" /></div>
				{/if}
				{if $prop.PROP_STATUS == "Under offer"}
					<div class="propstatus"><img src="{$__imgDir}underoffer.png" alt="Under Offer Banner" width="400px" height="267" /></div>
				{/if}
				{if $prop.PROP_STATUS == "Let"}
					<div class="propstatus"><img src="{$__imgDir}let.png" alt="Let Banner" width="400px" height="267" /></div>
				{/if}
			{else}
				<img src="/thumb.php?pic=no-pic.png&amp;path=views/tc-burg_revamp/images/&amp;width=400" alt="No Picture" width="400px" />
			{/if}
		</div>
