	...
	<div class="property">
		<div class="property-banner">
			...
			<div class="property-bannerdetail">
				{if $searchtype != "Commercial"}
					{$prop.PROP_BED} <img src="{$__imgDir}bed.png" alt="Number of bed picture" width="27" height="26" />
				{else}
					<img src="{$__imgDir}spacer.png" alt="" width="50" height="26" />
				{/if}
				<img src="{$__imgDir}spacer.png" alt="" width="50" height="26" />&pound; {$prop.PROP_Price|number_format:0:".":","}
		...
		<div class="property-col1">
			...
			{if file_exists($pic1)}
				<div><a href="/propimages/house{$prop.PROP_KEY}.jpg" rel="lightbox[{$prop.PROP_KEY}]" title="Enlarge Main Picture of Property REF {$prop.PROP_KEY}"><img src="/thumb.php?pic=house{$prop.PROP_KEY}.jpg&amp;path=propimages&amp;width=400&amp;height=267" alt="Main Property Picture" width="400px" height="267" /></a></div>
				{if $prop.PROP_STATUS == "Sold"}
					<div class="propstatus"><img src="/views/tc-pic/images/sold.png" alt="Sold Banner" width="400px" height="267" /></div>
				{/if}
				{if $prop.PROP_STATUS == "Sale Agreed"}
					<div class="propstatus"><img src="/views/tc-pic/images/saleagreed.png" alt="Sale Agreed Banner" width="400px" height="267" /></div>
				{/if}
				{if $prop.PROP_STATUS == "Under offer"}
					<div class="propstatus"><img src="/views/tc-pic/images/underoffer.png" alt="Under Offer Banner" width="400px" height="267" /></div>
				{/if}
				{if $prop.PROP_STATUS == "Let"}
					<div class="propstatus"><img src="/views/tc-pic/images/let.png" alt="Let Banner" width="400px" height="267" /></div>
				{/if}
			{else}
				<img src="/thumb.php?pic=no-pic.png&path=views/tc-pic/images/&width=400" alt="No Picture" width="400px" />
			{/if}
		</div>
		<div class="property-col2">{$prop.PROP_SUMMARY}</div>
