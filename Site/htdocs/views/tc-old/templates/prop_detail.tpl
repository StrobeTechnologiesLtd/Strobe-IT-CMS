...
{block name=body}
	<div id="property">
		<div id="property-banner">
			<div id="property-bannertitle"><h2>{$prop_name}</h2></div>
			<div id="property-bannerdetail">
				{$prop_bed} <img src="{$__imgDir}bed.png" alt="Number of bed picture" width="27" height="26" /><br />
		...
		<div id="property-menu">
			<ul>
				...
				{if file_exists($brouchure)}
					<li><a href="/pdf/{$prop_key}.pdf"><span>Download Brouchure</span></a></li>
				{/if}
