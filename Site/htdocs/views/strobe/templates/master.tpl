...
<html lang="en">
  ...
  (function() {
    ...
    var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(ga, s);
	    ...
	    <title>{block name=title}Strobe IT - Template{/block}</title>
    </head>
    <body> 
<div id="fb-root"></div>
        ...
        <div id="site-container">
            <div id="site-wrapper">
                ...
                <header id="header">
					...
					<div id="logo">
						<img src="{$__imgDir}logo.png" alt="Strobe IT Logo" height="71" width="250" />
						<h3 class="float-right">&nbsp; &nbsp;Strobe Technologies CMS System Demo</h3>
					</div>
                </header>
                ...
                <footer id="footer">
                    <div id="footer-left">
                        <a href="#" title="Follow Us via Fackbook"><img src="{$__imgDir}fb.png" alt="Follow Us on Facebook" width="35" height="35" /></a>
						<a href="#" title="Follow Us via Twitter"><img src="{$__imgDir}tw.png" alt="Follow Us on Twitter" width="35" height="35" /></a>
						<a href="#" title="Follow Us via LinkedIn"><img src="{$__imgDir}in.png" alt="Follows Us via LinkedIn" width="35" height="35" /></a>
						<a href="#" title="Follow Us via Google+"><img src="{$__imgDir}gp.png" alt="Follow Us on Google+" width="35" height="35" /></a>
                    </div>
                    <div id="footer-right">
