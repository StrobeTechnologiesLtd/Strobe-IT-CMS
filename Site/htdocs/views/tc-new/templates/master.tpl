            ...
            <div id="site-wrapper">
                ...
                <header id="header">
					<div id="slideshow1" class="pics">
						<img src="{$__imgDir}header1.jpg" height="350" width="900" alt="Header Picture" />
						<img src="{$__imgDir}header2.jpg" height="350" width="900" alt="Header Picture" />
						<img src="{$__imgDir}header3.jpg" height="350" width="900" alt="Header Picture" />
						<img src="{$__imgDir}header4.jpg" height="350" width="900" alt="Header Picture" />
						<img src="{$__imgDir}header5.jpg" height="350" width="900" alt="Header Picture" />
						<img src="{$__imgDir}header6.jpg" height="350" width="900" alt="Header Picture" />
						<img src="{$__imgDir}header7.jpg" height="350" width="900" alt="Header Picture" />
						<img src="{$__imgDir}header8.jpg" height="350" width="900" alt="Header Picture" />
						<img src="{$__imgDir}header9.jpg" height="350" width="900" alt="Header Picture" />
						<img src="{$__imgDir}header10.jpg" height="350" width="900" alt="Header Picture" />
						<img src="{$__imgDir}header11.jpg" height="350" width="900" alt="Header Picture" />
						<img src="{$__imgDir}header12.jpg" height="350" width="900" alt="Header Picture" />
					</div>
					<div id="logo">
						<img src="{$__imgDir}logo.png" alt="Thorne and Carter Logo" height="71" width="250" />
						<h3 class="float-right">&nbsp; &nbsp;Over One Hundred years in the Culm Valley</h3>
					</div>
                </header>
