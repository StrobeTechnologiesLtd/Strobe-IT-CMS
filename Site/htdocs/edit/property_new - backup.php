...
// This page displays the new property screen & creates the required property
	...
	try {
		if ($_SERVER['REQUEST_METHOD'] == 'POST') {
			...
			//$r = $property->setPROP_MAIN_LOC($_POST['PROP_MAIN_LOC']);
			//$r = $property->setPROP_MAIN_CAPTION($_POST['PROP_MAIN_CAPTION']);
			//$r = $property->setPROP_ADD1_LOC($_POST['PROP_ADD1_LOC']);
			//$r = $property->setPROP_ADD1_CAPTION($_POST['PROP_ADD1_CAPTION']);
			//$r = $property->setPROP_ADD2_LOC($_POST['PROP_ADD2_LOC']);
			//$r = $property->setPROP_ADD2_CAPTION($_POST['PROP_ADD2_CAPTION']);
			//$r = $property->setPROP_ADD3_LOC($_POST['PROP_ADD3_LOC']);
			//$r = $property->setPROP_ADD3_CAPTION($_POST['PROP_ADD3_CAPTION']);
			//$r = $property->setPROP_MAP1_LOC($_POST['PROP_MAP1_LOC']);
			//$r = $property->setPROP_MAP1_CAPTION($_POST['PROP_MAP1_CAPTION']);
			//$r = $property->setPROP_MAP2_LOC($_POST['PROP_MAP2_LOC']);
			//$r = $property->setPROP_MAP2_CAPTION($_POST['PROP_MAP2_CAPTION']);
			//$r = $property->setPROP_MAP3_LOC($_POST['PROP_MAP3_LOC']);
			$//r = $property->setPROP_MAP3_CAPTION($_POST['PROP_MAP3_CAPTION']);
			$r = $property->setPROP_SHOW_NAME($_POST['PROP_SHOW_NAME']);
			//$r = $property->setPROP_KEY($_POST['PROP_PROP_KEY']);
			//$r = $property->setPROP_ADD4_LOC($_POST['PROP_ADD4_LOC']);
			//$r = $property->setPROP_ADD4_CAPTION($_POST['PROP_ADD4_CAPTION']);
			//$r = $property->setPROP_ADD_DATE($_POST['PROP_ADD_DATE']);
			...
			if ($msg) {
				...
				/*$smarty->assign('form_PROP_MAIN_LOC', $_POST['PROP_MAIN_LOC']);
				$smarty->assign('form_PROP_MAIN_CAPTION', $_POST['PROP_MAIN_CAPTION']);
				$smarty->assign('form_PROP_ADD1_LOC', $_POST['PROP_ADD1_LOC']);
				$smarty->assign('form_PROP_ADD1_CAPTION', $_POST['PROP_ADD1_CAPTION']);
				$smarty->assign('form_PROP_ADD2_LOC', $_POST['PROP_ADD2_LOC']);
				$smarty->assign('form_PROP_ADD2_CAPTION', $_POST['PROP_ADD2_CAPTION']);
				$smarty->assign('form_PROP_ADD3_LOC', $_POST['PROP_ADD3_LOC']);
				$smarty->assign('form_PROP_ADD3_CAPTION', $_POST['PROP_ADD3_CAPTION']);
				$smarty->assign('form_PROP_MAP1_LOC', $_POST['PROP_MAP1_LOC']);
				$smarty->assign('form_PROP_MAP1_CAPTION', $_POST['PROP_MAP1_CAPTION']);
				$smarty->assign('form_PROP_MAP2_LOC', $_POST['PROP_MAP2_LOC']);
				$smarty->assign('form_PROP_MAP2_CAPTION', $_POST['PROP_MAP2_CAPTION']);
				$smarty->assign('form_PROP_MAP3_LOC', $_POST['PROP_MAP3_LOC']);
				$smarty->assign('form_PROP_MAP3_CAPTION', $_POST['PROP_MAP3_CAPTION']);*/
				$smarty->assign('prop_show_name_checked ',$_POST['PROP_SHOW_NAME']);
			//$r = $property->setPROP_KEY($_POST['PROP_PROP_KEY']);
				//$smarty->assign('form_PROP_ADD4_LOC', $_POST['PROP_ADD4_LOC']);
				//$smarty->assign('form_PROP_ADD4_CAPTION', $_POST['PROP_ADD4_CAPTION']);
			//$r = $property->setPROP_ADD_DATE($_POST['PROP_ADD_DATE']);
				...
				// SQL to insert new page:
 				//$q = 'INSERT INTO PROPERTY (PROP_REF, PROP_PRICE_PREFIX, PROP_PRICE, PROP_TENURE, PROP_HOUSE_TYPE, PROP_STATUS, PROP_BED, PROP_NAME, PROP_ADDRESS, PROP_POSTCODE, PROP_SUMMARY, PROP_DETAILED, PROP_MAIN_LOC, PROP_MAIN_CAPTION, PROP_ADD1_LOC, PROP_ADD1_CAPTION, PROP_ADD2_LOC, PROP_ADD2_CAPTION, PROP_ADD3_LOC, PROP_ADD3_CAPTION, PROP_MAP1_LOC, PROP_MAP1_CAPTION, PROP_MAP2_LOC, PROP_MAP2_CAPTION, PROP_MAP3_LOC, PROP_MAP3_CAPTION, PROP_SHOW_NAME, PROP_KEY, PROP_ADD4_LOC, PROP_ADD4_CAPTION, PROP_ADD_DATE, PROP_CONDITION, PROP_COPYRIGHT, PROP_PRICE_TEXT, PROP_FISH, PROP_RIGHTMOVE, PROP_COMING_SOON, PROP_EER_CUR, PROP_EER_POT, PROP_EIR_CUR, PROP_EIR_POT) VALUES (:PROP_REF, :PROP_PRICE_PREFIX, :PROP_PRICE, :PROP_TENURE, :PROP_HOUSE_TYPE, :PROP_STATUS, :PROP_BED, :PROP_NAME, :PROP_ADDRESS, :PROP_POSTCODE, :PROP_SUMMARY, :PROP_DETAILED, :PROP_MAIN_LOC, :PROP_MAIN_CAPTION, :PROP_ADD1_LOC, :PROP_ADD1_CAPTION, :PROP_ADD2_LOC, :PROP_ADD2_CAPTION, :PROP_ADD3_LOC, :PROP_ADD3_CAPTION, :PROP_MAP1_LOC, :PROP_MAP1_CAPTION, :PROP_MAP2_LOC, :PROP_MAP2_CAPTION, :PROP_MAP3_LOC, :PROP_MAP3_CAPTION, :PROP_SHOW_NAME, :PROP_PROP_KEY, :PROP_ADD4_LOC, :PROP_ADD4_CAPTION, :PROP_ADD_DATE, :PROP_CONDITION, :PROP_COPYRIGHT, :PROP_PRICE_TEXT, :PROP_FISH, :PROP_RIGHTMOVE, :PROP_COMING_SOON, :PROP_EER_CUR, :PROP_EER_POT, :PROP_EIR_CUR, :PROP_EIR_POT)';
				//$q = 'INSERT INTO PROPERTY (PROP_REF, PROP_PRICE_PREFIX, PROP_PRICE, PROP_TENURE, PROP_HOUSE_TYPE, PROP_STATUS, PROP_BED, PROP_NAME, PROP_ADDRESS, PROP_POSTCODE, PROP_SUMMARY, PROP_DETAILED, PROP_MAIN_LOC, PROP_MAIN_CAPTION, PROP_ADD1_LOC, PROP_ADD1_CAPTION, PROP_ADD2_LOC, PROP_ADD2_CAPTION, PROP_ADD3_LOC, PROP_ADD3_CAPTION, PROP_MAP1_LOC, PROP_MAP1_CAPTION, PROP_MAP2_LOC, PROP_MAP2_CAPTION, PROP_MAP3_LOC, PROP_MAP3_CAPTION, PROP_SHOW_NAME, PROP_ADD4_LOC, PROP_ADD4_CAPTION, PROP_CONDITION, PROP_COPYRIGHT, PROP_PRICE_TEXT, PROP_FISH, PROP_RIGHTMOVE, PROP_COMING_SOON, PROP_EER_CUR, PROP_EER_POT, PROP_EIR_CUR, PROP_EIR_POT) VALUES (:PROP_REF, :PROP_PRICE_PREFIX, :PROP_PRICE, :PROP_TENURE, :PROP_HOUSE_TYPE, :PROP_STATUS, :PROP_BED, :PROP_NAME, :PROP_ADDRESS, :PROP_POSTCODE, :PROP_SUMMARY, :PROP_DETAILED, :PROP_MAIN_LOC, :PROP_MAIN_CAPTION, :PROP_ADD1_LOC, :PROP_ADD1_CAPTION, :PROP_ADD2_LOC, :PROP_ADD2_CAPTION, :PROP_ADD3_LOC, :PROP_ADD3_CAPTION, :PROP_MAP1_LOC, :PROP_MAP1_CAPTION, :PROP_MAP2_LOC, :PROP_MAP2_CAPTION, :PROP_MAP3_LOC, :PROP_MAP3_CAPTION, :PROP_SHOW_NAME, :PROP_ADD4_LOC, :PROP_ADD4_CAPTION, :PROP_CONDITION, :PROP_COPYRIGHT, :PROP_PRICE_TEXT, :PROP_FISH, :PROP_RIGHTMOVE, :PROP_COMING_SOON, :PROP_EER_CUR, :PROP_EER_POT, :PROP_EIR_CUR, :PROP_EIR_POT)';
