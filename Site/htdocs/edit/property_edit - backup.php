		...
		if ($_SERVER['REQUEST_METHOD'] == 'POST') {
			...
			if ($r) {
				...
				if ($property) {
					...
					$smarty->assign('form_PROP_MAP1_LOC', $property->getPROP_MAP1_LOC());
					$smarty->assign('form_PROP_MAP1_CAPTION', $property->getPROP_MAP1_CAPTION());
					$smarty->assign('form_PROP_MAP2_LOC', $property->getPROP_MAP2_LOC());
					$smarty->assign('form_PROP_MAP2_CAPTION', $property->getPROP_MAP2_CAPTION());
					$smarty->assign('form_PROP_MAP3_LOC', $property->getPROP_MAP3_LOC());
					$smarty->assign('form_PROP_MAP3_CAPTION', $property->getPROP_MAP3_CAPTION());
